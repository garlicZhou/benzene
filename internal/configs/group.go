...
const (
	MaxShards = 32 // maximum number of shards. It is also the maximum number of configs.
)
...
func getNetworkPrefix(shardID uint64) (netPre string) {
	return "benzene"
}

// NewGroupIDByShardID returns a new groupID for a shard
func NewGroupIDByShardID(shardID uint64) GroupID {
...
func NewClientGroupIDByShardID(shardID uint64) GroupID {
